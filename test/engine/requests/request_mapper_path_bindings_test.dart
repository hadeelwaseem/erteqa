...
void main() {
  group('EngineRequestMapper pathBindings', () {
    ...
    test('buildRuntimeRequest returns unresolved when pageState slug missing', () {
      const base = EngineMappedRequest(
        key: 'category-products',
        requestUrl: null,
        rawRequestUrl:
    ...
    test('buildRuntimeRequest keeps category URL when slug resolved via pathBindings',
        () {
      const base = EngineMappedRequest(
        key: 'product-list',
        requestUrl: '/api/v1/public/products?page=0&size=20',
