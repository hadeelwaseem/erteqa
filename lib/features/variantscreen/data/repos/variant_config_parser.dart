...
/// Shared JSON → [ScreenConfig] parsing for asset and in-memory config sources.
class VariantConfigParser {
  VariantConfigParser._();
  ...
  static ScreenConfig parseFromRoot(
    Map<String, dynamic> json,
    String variantId, {
    String? pageRoute,
  }) {
    if (json['pages'] is List) {
      return parseBuilderScreenConfig(json, variantId, pageRoute: pageRoute);
    }
    return parseScreenConfig(json);
  }

  static ScreenConfig parseScreenConfig(Map<String, dynamic> json) {
  ...
  static ScreenConfig parseBuilderScreenConfig(
    Map<String, dynamic> json,
    String variantId, {
    String? pageRoute,
  }) {
    ...
    if (aliasesRaw != null) {
      for (final entry in aliasesRaw.entries) {
        ...
        if (entry.key.isNotEmpty && target is String && target.isNotEmpty) {
  ...
  static ComponentConfig _parseBuilderComponentConfig(
    Map<String, dynamic> json, {
  ...
  static Map<String, dynamic> _normalizeBuilderProperties(
    Map<String, dynamic> json,
    String rawType,
  ) {
  ...
  static ComponentConfig _parseComponentConfig(
    Map<String, dynamic> json, {
    required String path,
  }) {
    ...
    AppLogger.debug(
      '[VariantConfigParser] parse node type=$typeString path=$path',
    );
  ...
  static GenericComponentType _componentTypeFromString(
    String typeString, {
    bool strict = true,
  }) {
  ...
  static void _validateComponentJson(
    Map<String, dynamic> json, {
    required String path,
  }) {
    final rawType = json['type'] as String?;
